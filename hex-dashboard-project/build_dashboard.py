...
.tooltip-box .tip-title {{ font-weight:600; font-size:12px; margin-bottom:4px; color:#fff; }}
.tooltip-box .tip-formula {{ font-family:'IBM Plex Mono',monospace; font-size:11px; background:rgba(255,255,255,0.1); padding:5px 8px; border-radius:4px; margin:6px 0; display:block; color:#a5b4fc; letter-spacing:0.02em; }}
...
.tooltip-box .tip-formula .frac-num {{ border-bottom:1px solid #a5b4fc; padding:0 3px 1px; font-size:10px; }}
.tooltip-box .tip-formula .frac-den {{ padding:1px 3px 0; font-size:10px; }}
.tooltip-box .tip-formula sup {{ font-size:8px; vertical-align:super; }}
.tooltip-box .tip-body {{ color:rgba(255,255,255,0.8); }}
.tooltip-box .tip-bench {{ font-size:10px; color:rgba(255,255,255,0.6); margin-top:4px; font-style:italic; }}
...
<div id="tip-quick-ratio">
    ...
    <span class="tip-formula"><span class="frac"><span class="frac-num">New + Resurrected + Expansion</span><span class="frac-den">Churned + Contraction</span></span></span>
    <div class="tip-body">Measures growth efficiency. How many units gained for every unit lost.</div>
    <div class="tip-bench">&gt; 4&times; very healthy &middot; &lt; 1&times; shrinking</div>
</div>

<div id="tip-net-churn">
    <div class="tip-title">Net API Churn</div>
    <span class="tip-formula"><span class="frac"><span class="frac-num">Churned + Contraction &minus; Resurrected &minus; Expansion</span><span class="frac-den">Prior Period Revenue</span></span></span>
    <div class="tip-body">Negative = the existing base is growing even without new partners. The holy grail of net negative churn.</div>
</div>

<div id="tip-gross-retention">
    <div class="tip-title">Gross Retention</div>
    <span class="tip-formula"><span class="frac"><span class="frac-num">Retained Revenue</span><span class="frac-den">Prior Period Revenue</span></span> &times; 100</span>
    <div class="tip-body">The floor &mdash; how much revenue survives without any new business or expansion.</div>
    <div class="tip-bench">&gt; 80% healthy &middot; &lt; 60% critical</div>
</div>

<div id="tip-credit-payback">
    <div class="tip-title">Credit Payback</div>
    <span class="tip-formula"><span class="frac"><span class="frac-num">Cumulative Revenue</span><span class="frac-den">Credits Granted</span></span></span>
    <div class="tip-body">Above 1&times; = investment has paid back. Progress bar shows how close to breakeven.</div>
</div>

<div id="tip-token-cagr">
    <div class="tip-title">Token CAGR</div>
    <span class="tip-formula">(<span class="frac"><span class="frac-num">Latest Month</span><span class="frac-den">First Month</span></span>)<sup>12/n</sup> &minus; 1</span>
...
<div id="tip-last-active">
    ...
    <div class="tip-bench">&lt; 7d healthy &middot; 7&ndash;14d at risk &middot; &gt; 14d likely dormant</div>
</div>
...
<div id="tip-cmgr3">
    <div class="tip-title">CMGR-3</div>
    <span class="tip-formula">(<span class="frac"><span class="frac-num">V<sub>t</sub></span><span class="frac-den">V<sub>t&minus;3</sub></span></span>)<sup>1/3</sup> &minus; 1</span>
    <div class="tip-body">Compound Monthly Growth Rate over trailing 3 months. Captures recent momentum.</div>
</div>

<div id="tip-cmgr6">
    <div class="tip-title">CMGR-6</div>
    <span class="tip-formula">(<span class="frac"><span class="frac-num">V<sub>t</sub></span><span class="frac-den">V<sub>t&minus;6</sub></span></span>)<sup>1/6</sup> &minus; 1</span>
    <div class="tip-body">Trailing 6-month CMGR. Smooths short-term volatility. Compare with CMGR-3 to detect acceleration or deceleration.</div>
</div>

<div id="tip-cmgr12">
    <div class="tip-title">CMGR-12</div>
    <span class="tip-formula">(<span class="frac"><span class="frac-num">V<sub>t</sub></span><span class="frac-den">V<sub>t&minus;12</sub></span></span>)<sup>1/12</sup> &minus; 1</span>
    <div class="tip-body">Long-term structural growth rate. If CMGR-3 &lt; CMGR-12, growth is decelerating.</div>
</div>

<div id="tip-abs-growth">
    <div class="tip-title">Absolute Monthly Growth</div>
    <span class="tip-formula">Tokens<sub>current</sub> &times; CMGR-3</span>
    <div class="tip-body">New tokens added per month. Rewards scale &mdash; a large partner growing slowly adds more absolute usage than a tiny one growing fast.</div>
</div>

<div id="tip-gw-score">
    <div class="tip-title">Growth-Weighted Score</div>
    <span class="tip-formula">log<sub>10</sub>(Tokens) &times; CMGR-3 &times; 100</span>
    <div class="tip-body">Balances scale and velocity. The log transform prevents volume from completely dominating the score.</div>
</div>

<div id="tip-proj-12mo">
    <div class="tip-title">Projected 12-Month Run-Rate</div>
    <span class="tip-formula">Tokens<sub>current</sub> &times; (1 + CMGR-3)<sup>12</sup></span>
    <div class="tip-body">Where this partner lands in 12 months if trailing 3-month growth continues. The primary power law ranking metric.</div>
</div>

<div id="tip-rev-impact">
    <div class="tip-title">Revenue Impact (6-month)</div>
    <span class="tip-formula">Revenue<sub>current</sub> &times; (1 + CMGR-3)<sup>6</sup></span>
    <div class="tip-body">Projected monthly revenue in 6 months. Factors in model mix since Opus tokens generate more revenue per token than Haiku.</div>
</div>
