...
.tab-group-label {{ font-size:8px; font-weight:700; text-transform:uppercase; letter-spacing:0.1em; color:{MUTED}; position:absolute; top:2px; left:50%; transform:translateX(-50%); pointer-events:none; white-space:nowrap; }}
...
.tab-linkedin:hover {{ color:#0a66c2; }}
...
<div class="tabs">
    ...
    <a href="https://www.linkedin.com/in/ongun-ozdemir/" target="_blank" class="tab tab-linkedin" style="text-decoration:none;">
    ...
    <div class="tab-panel" id="panel-about">
        ...
        <div style="background:{CARD};border:1px solid {GRID};border-radius:10px;padding:24px;margin-top:16px;max-width:600px;">
            ...
            <div style="display:flex;gap:16px;">
                ...
                <a href="https://github.com/OOngun/anthropic-application" target="_blank" style="display:inline-flex;align-items:center;gap:6px;color:{ACCENT};text-decoration:none;font-size:13px;font-weight:500;">
